...
//! - Windows: `%APPDATA%/blackhole/{scheme}.userdb.txt`
//! - Linux/macOS: `~/.local/share/blackhole/{scheme}.userdb.txt`
...
/// 获取默认用户数据目录
/// - Windows: `%APPDATA%/blackhole`
/// - Linux/macOS: `~/.local/share/blackhole`
...
mod tests {
    ...
    fn test_persistence_roundtrip() {
        let dir =
            std::env::temp_dir().join(format!("blackhole_userdb_test_{}", std::process::id()));
