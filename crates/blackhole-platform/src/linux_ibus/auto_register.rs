...
<component>
  <name>org.freedesktop.IBus.Blackhole</name>
  <description>Blackhole IME</description>
  <exec>{exec_path} --ibus</exec>
  <version>0.1.0</version>
  <author>Blackhole IME Team</author>
  <license>MIT</license>
  <homepage>https://github.com/blackhole/ime</homepage>
  <textdomain>blackhole</textdomain>
  <engines>
    <engine>
      <name>blackhole</name>
      ...
      <license>MIT</license>
      <author>Blackhole IME Team</author>
      <icon>/usr/share/ibus-blackhole/icons/blackhole.svg</icon>
      <layout>us</layout>
      <longname>Blackhole</longname>
      <description>Blackhole IME with Pinyin and Shuangpin support</description>
      <rank>99</rank>
      <symbol>CJ</symbol>
    </engine>
  </engines>
...
///
/// 将 XML 写入 `~/.config/ibus/component/blackhole.xml`，
...
pub fn register_ime() -> std::io::Result<()> {
    ...
    let xml_path = component_dir.join("blackhole.xml");
...
fn ibus_component_path() -> PathBuf {
    ibus_component_dir().join("blackhole.xml")
}
